...
```bash
git remote add encore encore://saas-hub-dashboard-hqhi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/saas-hub-dashboard-hqhi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/saas-hub-dashboard-hqhi/settings/integrations/github)
