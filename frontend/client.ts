...
export namespace hub {
    ...
    export class ServiceClient {
        ...
        public async adminMemberships(): Promise<ResponseType<typeof api_hub_admin_memberships_adminMemberships>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/_admin/memberships`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hub_admin_memberships_adminMemberships>
        }

        public async adminPromoteNext(): Promise<ResponseType<typeof api_hub_admin_memberships_adminPromoteNext>> {
            // Now make the actual call to the API
        ...
        public async generateResponse(params: RequestType<typeof api_hub_openai_generateResponse>): Promise<ResponseType<typeof api_hub_openai_generateResponse>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hub_openai_generateResponse>
        }

        public async getMembership(): Promise<ResponseType<typeof api_hub_me_membership_getMembership>> {
            // Now make the actual call to the API
        ...
        public async webhookKiwify(options: PickMethods<"POST"> = {}): Promise<globalThis.Response> {
            options.method ||= "POST";
            return this.baseClient.callAPI(`/webhooks/kiwify`, options)
        }

        public async webhookKiwifyDebug(options: PickMethods<"GET"> = {}): Promise<globalThis.Response> {
            options.method ||= "GET";
            return this.baseClient.callAPI(`/webhooks/kiwify/_debug`, options)
        }

        public async whoami(): Promise<ResponseType<typeof api_hub_debug_whoami_whoami>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/debug/whoami`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_hub_debug_whoami_whoami>
        }
    }
}
    ...
    async getAuthData(): Promise<CallParameters | undefined> {
        ...
        if (authData) {
            ...
            data.headers = makeRecord<string, string>({
                ...
                "x-dev-auth":  authData["x-dev-auth"],
            });
